...
function SimplePlane() {
    ...
    // Vec2 is the class used for all 2-dimension vector manipulations
    ...
    const uniforms = {
        ...
        mouseMoveStrength: {
            // how fast and wide the mouse is moved
    ...
    useCurtains((curtains) => {
        const onMouseMove = (e) => {
            ...
            // lerp the position a bit to smoothen the overall effect
            ...
            if (plane) {
                ...
                plane.uniforms.mousePosition.value =
                    plane.mouseToPlaneCoords(mousePosition.current)
            }
        }
    ...
    const onRender = (plane) => {
        ...
        // decrease both deltas by damping: if the user doesnt move the mouse,
        // the effect will fade away
        deltas.current.applied += (deltas.current.max - deltas.current.applied) * 0.5
